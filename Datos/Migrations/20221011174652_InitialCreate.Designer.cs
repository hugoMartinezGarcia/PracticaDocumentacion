...
namespace Datos.Migrations
{
    ...
    [Migration("20221011174652_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.Category", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Customer", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Order", b =>
                {
            ...
            modelBuilder.Entity("Entidades.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("Entidades.Shipper", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entidades.Employee", b =>
                {
                    b.HasOne("Entidades.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("Entidades.Order", b =>
                {
                    b.HasOne("Entidades.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("Entidades.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("Entidades.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Entidades.OrderDetail", b =>
                {
                    b.HasOne("Entidades.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("Entidades.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Entidades.Product", b =>
                {
                    b.HasOne("Entidades.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("Entidades.Supplier", "Supplier")
                        .WithMany("Products")
